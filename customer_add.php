...
<body>
    <!-- ==================== 导航栏 ==================== -->
    <nav class="navbar">
        <div class="navbar-brand">👥 添加客户</div>
        <div class="navbar-actions">
            <a href="customers.php" class="btn btn-secondary">返回列表</a>
            <button class="btn btn-success" onclick="saveCustomer()">保存客户</button>
        </div>
    </nav>
            ...
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" class="form-textarea" 
                              placeholder="请输入公司地址（可选）" rows="3"></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">备注</label>
                    <textarea name="notes" class="form-textarea" 
                              placeholder="其他备注信息（可选）" rows="4"></textarea>
                </div>
            </div>
        </form>
    </main>
